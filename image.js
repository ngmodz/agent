document.addEventListener('DOMContentLoaded', () => {
    ...
    // Instagram logo SVG with gradient colors
    const instagramLogo = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="256" height="256" viewBox="0 0 256 256">
        <defs>
    ...
    function drawBlackTextContent(ctx, width, height) {
        ...
        // Draw category (or logo for Instagram)
        if (formData.category === 'Instagram') {
            // Draw Instagram logo instead of text
            ...
            const svgBlob = new Blob([instagramLogo], {type: 'image/svg+xml'});
